    ...
    <div className="max-w-[1280px] mx-auto px-4 sm:px-6 md:px-8 py-10 space-y-8 text-primary">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-border pb-6">
        <div className="space-y-1">
          ...
          <p className="text-sm text-secondary font-medium">Browse live and offline developer streams across all communities</p>
        </div>
      </div>
      ...
      {streams.length > 0 ? (
        ...
        <div className="border border-border rounded-lg bg-surface p-12 text-center max-w-xl mx-auto space-y-4">
          ...
          <Link
            href="/dashboard"
            className="inline-flex h-9 px-4 items-center justify-center rounded-md bg-accent hover:bg-violet-600 text-white font-medium text-sm transition-colors mt-2"
          >
